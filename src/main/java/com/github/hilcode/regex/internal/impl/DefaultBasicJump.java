...
public final class DefaultBasicJump
	implements
		BasicInstruction.Ephemeral.Jump
{
	...
	{
		@Override
		public BasicInstruction.Ephemeral.Jump newBasicJump(final int programCounterDelta)
		{
			return new DefaultBasicJump(programCounterDelta);
		}
	}

	private final int programCounterDelta;

	public DefaultBasicJump(final int programCounterDelta)
	{
	...
	{
		return format("JMP %+d", Integer.valueOf(this.programCounterDelta));
	}
